angular.module("myApp", ["ionic"])
        ...
        $stateProvider
            ...
            .state("frame.activedetails",{
                url: "/start/activedetails/:id",
                views: {
                    "start": {
                        templateUrl: "/activedetails",
...
//                      { text: '关闭' }
    ...
    .controller('AppCtrl', function ($scope, $ionicModal, $interval) {
        ...
        $ionicModal.fromTemplateUrl('/phone', {
            scope: $scope
        ...
        $ionicModal.fromTemplateUrl('/email', {
            scope: $scope
    ...
    .controller('BuyCtrl', function ($scope, $ionicModal) {
        ...
        $ionicModal.fromTemplateUrl('/buy', {
            scope: $scope
    ...
    .controller('OrderCtrl', function ($scope, $ionicModal, $ionicPopup) {
        ...
        $ionicModal.fromTemplateUrl('/changeplace', {
            scope: $scope
